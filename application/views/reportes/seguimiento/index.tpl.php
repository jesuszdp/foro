...
<?php echo js("js_export_grid/complemento_export_grid.js"); ?>

<?php echo js('reportes/seguimiento/seguimiento.js'); ?>

<script type="text/javascript">
    var lang_tmp = "<?php echo $lang; ?>";
</script>
<div class="panel panel-default">
    <h1 class="page-head-line"><?php echo "Reportes de seguimiento"; ?></h1>
    <div class="panel-body">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
                <div class="media">
                    <span class="pull-left">
                        <i class="fa fa-institution fa-2x media-object"></i>
                    </span>
                    <div class="media-body">
        ...
        <div class="col-md-12 col-sm-12">
            <a href="#" type="button" class="btn btn-theme animated flipInY visible pull-right" aria-expanded="false" onclick="exportar_investigacion(this);" data-namegrid="jsTrabajosInvestigacion">
                <span><?php echo $language_text['dashboard']['exportar']; ?></span>
            </a>
        </div><br>
        <div class="row" id="jsTrabajosInvestigacion"></div>
    </div>
</div>

...
<div class="schedule-wrapper clear" data-animation="fadeIn" data-animation-delay="200">
    <div class="schedule-tabs lv1">
        <ul id="tabs-lv1"  class="nav nav-justified">
            ...
            <li class="tab_reporte_calidad" id="calidad_seccion" data-tab="5"> <a href="<?php echo base_url("index.php/reportes_institucion/reportes/5"); ?>"><strong><?php echo /*$language_text['reportes_imss']['tab_calidad'];*/ 'Calidad de trabajos por sección'?></strong> <br/></a></li>
        </ul>
    </div>

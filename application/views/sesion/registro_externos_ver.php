    ...
    <form name="af-form" method="post" action="#contact" class="af-form row" id="af-form">
      ...
      <div class="col-sm-12 af-outer af-required">
        ...
        <div class="form-group af-inner">
          <input type="text" name="name" id="name" value="<?php echo $params[''];?>" size="30" data-toggle="tooltip" title="" class="form-control placeholder " data-original-title="" style="color:#000000;">
        </div>
      </div>
      <div class="col-sm-12 af-outer af-required">
        <div class="col-sm-3">

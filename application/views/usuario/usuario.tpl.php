...
?>
<?php
$id_form = 'form_actualizar';
if($usuario['es_imss']){
  $id_form = 'form_actualizar_interno';
}else{
  $id_form = 'form_actualizar_externo';
}
?>
<div id="page-inner">
  <div class="col-sm-12">
  ...
  <div class="col-sm-12">
      <?php
      echo form_open('usuario/editar/' . $usuario['id_usuario'] . '/' . Usuario::BASICOS, array('id' => $id_form));
      ?>
  ...
  <div class="col-sm-12">
    <div class="col-sm-2">
      <label>Actividad del usuario</label>
    </div>

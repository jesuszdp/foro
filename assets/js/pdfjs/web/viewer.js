...
var DEFAULT_URL = '../../../assets/js/pdfjs/web/SIPIMSS.pdf';
...
function configure(PDFJS) {
  PDFJS.imageResourcesPath = '../../../assets/js/pdfjs/images/';
  PDFJS.workerSrc = '../../../assets/js/pdfjs/build/pdf.worker.js';
  PDFJS.cMapUrl = '../../../assets/js/pdfjs/web/cmaps/';
...
function getViewerConfiguration() {
  return {
    ...
    debuggerScriptPath: '../../../assets/js/pdfjs/web/debugger.js',
  };
}

...
function registros() {
    ...
    grid = $('#jsTrabajosInvestigacion').jsGrid({
        height: "1000px",
        width: "100%",
//        deleteConfirm: "¿Deseas eliminar este registro?",
        ...
        controller: {
            loadData: function (filter) {
                ...
                $.ajax({
                    type: "GET",
                    url: site_url + "/reportes_seguimiento/informacion",
                    dataType: "json"
                })
...
//                            calcula_ancho_grid('jsReporteHechos', 'jsgrid-header-cell');
        ...
        fields: [
            ...
            {name: "pais", title: name_fields.pais, type: "text", inserting: false, editing: false},
            {name: "estado", title: name_fields.estado, type: "text", inserting: false, editing: false},
            ...
            {name: "promedio", title: name_fields.promedio, type: "text", inserting: false, editing: false},
